...
tools: ["changes","edit","extensions","fetch","githubRepo","new","openSimpleBrowser","problems","runCommands","runNotebooks","runTasks","search","testFailure","todos","usages","vscodeAPI","ms-azuretools.vscode-azure-github-copilot/azure_get_auth_context","ms-azuretools.vscode-azure-github-copilot/azure_set_auth_context","ms-azuretools.vscode-azure-github-copilot/azure_query_azure_resource_graph","Azure MCP/extension_cli_generate","Azure MCP/applens","Azure MCP/bicepschema","Azure MCP/monitor","Azure MCP/get_bestpractices","Azure MCP/deploy","Azure MCP/quota","Azure MCP/documentation"]
